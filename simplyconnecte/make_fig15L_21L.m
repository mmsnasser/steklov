...
ylabel('Eigenvalues')
print -depsc fig_ex_ell_10eig
%%
figure;
hold on; box on
plot(r,1./xe(1,:)+1./xe(2,:),'LineWidth',1.5);
plot(r,xe(1,:).*xe(2,:),'LineWidth',1.5);
legend({'$\frac{1}{\lambda_1}+\frac{1}{\lambda_2}$','$\lambda_1\lambda_2$'},...
