...
% polygon with the vertices "ver' where "ns" is the number graded points on
% each side of the polygon. The number of graded points for the whole 
% polygon is "n=number os sides*ns". The graded mesh points are computed by 
% the function "deltw.m".
% 
% 
n      =   length(ver)*ns;
